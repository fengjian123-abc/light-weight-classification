...
def get_args_parser():
    parser = argparse.ArgumentParser('LCvTNet training and evaluation script for image classification', add_help=False)
    ...
    # Model parameters
    parser.add_argument('--model', default='lcvtnet_xxx_small', type=str, metavar='MODEL',help='Name of model to train')
    ...
    parser.add_argument('--lr', type=float, default=5e-4, metavar='LR',help='learning rate (default: 6e-3), with total batch size 512')
    ...
    parser.add_argument('--warmup_start_lr', type=float, default=0, metavar='LR',help='Starting LR for warmup (default 0)')

    '''
        DataAugment : No AA, Color Jitter=0.4, No Mixup & Cutmix, DropPath=0.0, BS=4096, lr=0.006, multi-scale-sampler
    '''
    ...
    # Dataset parameters
    # ★★★★
    # parser.add_argument('--data_path', default='./train_data', type=str,help='dataset path (path to full imagenet)')
    # parser.add_argument('--data_path', default='/home/chen/ImageNet_1k', type=str,help='dataset path (path to full imagenet)')
    # ./Datasets/CIFAR100
    # /home/workstation/datasets/ImageNet_1k
    parser.add_argument('--data_path', default='/home/workstation/datasets/ImageNet_1k', type=str,help='dataset path (path to full imagenet)')
    ...
    # ★★★★
    parser.add_argument('--data_set', default='IMNET', choices=['IMNET', 'image_folder'],type=str, help='ImageNet dataset path')
    parser.add_argument('--output_dir', default='./train_save_imagenet_1k_xxxs',help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default = None,help='path where to tensorboard log')
    parser.add_argument('--device', default='cuda',help='device to use for training / testing')
    parser.add_argument('--seed', default=0, type=int)

    parser.add_argument('--resume', default='',help='resume from checkpoint')
    parser.add_argument('--finetune', default='',help='finetune the model')
    ...
    parser.add_argument('--use_amp', type=str2bool, default=True,help="Use PyTorch's AMP (Automatic Mixed Precision) or not")

    # Weights and Biases arguments
    parser.add_argument('--enable_wandb', type=str2bool, default=False,help="enable logging to Weights and Biases")
    parser.add_argument('--project', default='lcvtnet', type=str,help="The name of the W&B project where you're sending the new run.")
    ...
    parser.add_argument("--find_unused_params", action="store_true",help="Set this flag to enable unused parameters finding in DistributedDataParallel()")
    parser.add_argument("--three_aug", action="store_true",help="Either to use three augments proposed by DeiT-III")
    parser.add_argument('--classifier_dropout', default=0.0, type=float)
    parser.add_argument('--usi_eval', type=str2bool, default=False,help="Enable it when testing USI model.")
    return parser
